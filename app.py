...
<body>
    <div class="container">
        <h1>Python Users List Version 6</h1>
...
def submit():
    ...
    try:
        ...
        return redirect('/retrieve')   # 🔥 IMPORTANT CHANGE

    except mysql.connector.Error as err:
        print("❌ DB ERROR:", err)   # 🔥 THIS WILL SHOW REAL ISSUE

        return f"Database Error: {err}"   # 🔥 SHOW ERROR ON SCREEN
